...
public class CadastroMarcaController implements Initializable {
    ...
    @FXML
    private TableColumn<Marca, String> colDescricao;
    ...
    private void evtAlterar(ActionEvent event) {
        Marca c = (Marca) tabela.getSelectionModel().getSelectedItem();
    ...
    private void evtApagar(ActionEvent event) {
        ...
        if (a.showAndWait().get() == ButtonType.OK) {
            ...
            Marca c = tabela.getSelectionModel().getSelectedItem();
            if(dal.apagar(c))
            {
                carregaTabela("");
            }
    ...
    private void evtConfirmar(ActionEvent event) {
        ...
        {
            a.setTitle("Problema.");
            a.setContentText("Verifique seus dados");
        }
    ...
    private void evtPesquisar(ActionEvent event) {
        carregaTabela("upper(marca_descr) like '%"+txPesquisar.getText().toUpperCase()+"%'");
    }
